                                ...
                                <div class="box">
                                    <header>
                                        <div class="row-fluid body">
                                            <form name="filter" method="POST" action="sort-by-date.php" class="form-horizontal">
                                                <div class="control-group">
                                                    <label class="control-label">Show users from : </label>
                                                    <input class="input-tooltip" type="date" name="startDate"> to
                                                    <input class="input-tooltip" type="date" name="endDate">
