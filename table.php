                    ...
                    <div class="container-fluid">
                        ...
                        <div class="nav-collapse collapse">
                            ...
                            <ul class="nav">
                                ...
                                <li class="active">
                                    <a href="table.html">Visitors</a></li>
                                <li>
                                    <a href="file.html">Returning visitors</a></li>
                            </ul>
                            <!-- /.nav -->
                        </div>
                    </div>
            ...
            <ul id="menu" class="unstyled accordion collapse in">
                <li class="accordion-group ">
                    ...
                    <ul class="collapse " id="dashboard-nav">
                        <li><a href="index.html"><i class="icon-angle-right"></i> Visitors</a></li>
                        <li><a href="alterne.html"><i class="icon-angle-right"></i> Returning visitors</a></li>
                    </ul>
                </li>
                <li class="accordion-group ">
                    ...
                    <ul class="collapse " id="component-nav">
                        <li><a href="icon.html"><i class="icon-angle-right"></i> Visitors.xls</a></li>
                        <li><a href="progress.html"><i class="icon-angle-right"></i> Returning visitors.xls</a></li>
                    </ul>
                </li>
            </ul>
            <!-- /#menu -->
